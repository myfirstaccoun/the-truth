...
let langsText = ["🇸🇦 AR", "🇬🇧 EN", "🇫🇷 FR", "🇪🇸 ES", "🇩🇪 DE", "🇯🇵 JP", "🇮🇹 IT", "🇷🇺 RU"];
let langsContent = [
// عربي
`
<style>
...
// russia
`
<h1 class="title">Правда</h1>

<div class="part">
    Добро пожаловать, надеюсь, вы дочитали эту статью до конца, потому что это очень важно.Давайте двинемся дальше.

    <br><br>
    <h1>Первый абзац: Бог должен быть</h1>
    Давайте согласимся, что все происходящее имеет причину. Например, если кто-то вас ударит, вы почувствуете боль. Соответственно, мы приходим к выводу, что у каждого артефакта есть создатель, у каждой машины есть создатель, у каждого дома есть создатель и у вселенной есть создатель. Потому что все, что побуждает, имеет причину.<br><br>

    <img src="./universe.png">

    Если вы думаете, что Вселенная возникла в результате Большого взрыва, вы ошибаетесь. Потому что, когда вы говорите, что начало Вселенной было очень маленькой точкой, вы не отвечаете на вопрос: «Кто создал эту точку?» Ответ, конечно, Бог. Бог должен быть совершенным, чтобы иметь возможность создать вселенную, и Ему не должно быть равных, потому что именно Он создал творчество и разнообразие во вселенной, и вы должны поклоняться Ему, потому что именно Он создал вас.<br <br>

    И если вы считаете, что Вселенная была создана случайно, то вы ошибаетесь, потому что... (продолжение следует)
</div>

<div class="part">
    <h1>Второй абзац: Теория эволюции</h1>
    Во-первых, я хочу, чтобы вы знали, что Вселенная тонко настроена, и случай не может создать эту точно настроенную Вселенную. Во-вторых, давайте узнаем об основных принципах теории эволюции.<br><br>

    <h3>Основы теории</h3>
    1. Живые организмы каким-то образом возникли из неодушевленных предметов.<br>
    2. Природа наделяет живые организмы новыми свойствами, способными превращать их из одного вида в другой.<br>
    3. Приобретенные черты наследуются, и природа совокупно отбирает высших существ.<br>
    4. Природа создает сложные биологические системы из последовательных простых изменений.<br><br>

    Вывод состоит в том, что живые организмы «эволюционируют» без намерения или воли избранного или желающего Создателя, который знает, что он делает.<br><br>

    <h3>Обзор</h3>
    1. Живые организмы каким-то образом возникли из неодушевленных предметов:<br>
    Это миф, который был развеян посредством экспериментов, самым известным из которых стал эксперимент Франческо Реди, проведенный за два столетия до Дарвина. Он доказал, что живые организмы, которые, как считалось, возникли спонтанно из неодушевленных предметов, таких как пищевые отходы, произошли из внешней материи, из пищи в загрязненном воздухе.<br><br>

    Истина в том, что самогенерация по своей сути нелогична. Невозможно представить себе живое существо, возникшее самопроизвольно из неодушевленных предметов. Но они настояли на попытке! Они попытались, и миф был разрушен эмпирической наукой и разумом.<br><br>


    2. Природа придает организму новые свойства:<br>
    Это также миф, развалившийся вместе с открытиями Грегора Менделя, который доказал – спустя годы после Дарвина – что генетические характеристики детей не будут отклоняться от тех, которые были изначально у родителей. Это также произошло с открытиями эпигенетики, которые показали, что внешние факторы и факторы окружающей среды могут изменить способ считывания генетического материала в организме, активируя или отключая активированный признак, но они не добавляют генетический материал, который изначально там не было.<br><br>


    3. Приобретенные черты передаются по наследству, и природа совокупно отбирает высших существ:<br>
    Как вы подумали, это тоже падший миф. Мышцы кузнеца и плотника, например, не передаются по наследству их детям. Однако последователи Дарвина настояли на попытке. Вейсманн продолжал резать хвосты 19 поколениям мышей только для того, чтобы после долгих усилий удивиться, когда их потомство снова родилось с хвостами. Это означает, что приобретенный признак – отрубленный хвост – не передался детям.<br><br>

    Что тогда остается от теории Дарвина?<br><br>

    4. Природа создает сложные биологические системы из последовательных простых изменений:<br>
    Итак, вы понимаете, что для Дарвина означает естественный отбор? Обширное воображение Дарвина привело его к мысли, что природа, использование и пренебрежение; Древние организмы создавали простые телесные структуры, которые могли для чего-то служить организму, поэтому естественный отбор сохранил их. Кто не знал, что накопление этих структур приводит к образованию целостного и интегрированного органа, такого как крыло птицы или глаз животного?<br><br>

    <h2>История</h2>

    Чтобы понять рассуждения Дарвина, представьте себе землю, полную мусора. Через него проходит большое количество слепых людей, каждый из которых случайно берет в руки кусок мусора. Затем они входят в большое здание, дверь которого закрывается после каждого входа.<br><br>

    <img src="./junk.png">

    Прошли миллионы лет, и слепой собрал свои останки, умер и был похоронен под землей здания.<br>
    Однажды ворота здания открылись, и из ворот вылетел гигантский самолет Боинг, пилотируемый слепым человеком, и улетел в небо!<br>

    <img src="./air plane.png">

    Вы задавались вопросом: как слепой смог сесть на самолет?! Вам сказали: Он не хотел этого делать! А вот что случилось со слепым перед ним, так это то, что тот, кто подобрал для него полезный кусок хлама; Он передал его тем, кто пришел за ним, и некоторые из них взяли кусок ткани, чтобы защитить себя от холода. Другой взял утюг, чтобы защититься от солнца, третий взял штурвал самолета, с помощью которого они передвигали еду во время приготовления, а четвертый взял бутылку, которую они использовали в качестве щита в войне против своих слепых врагов!<br><br>

    Так продолжалось несколько раз подряд, и они завещали свои части тем, кто стал их преемником, и части собирались непреднамеренно, без активных действий, пока не образовался этот великий план, который вы видели!<br><br>

    Так что остерегайтесь иллюзий, что кто-то хочет, чтобы самолет сформировался или полетел!<br><br>
    Следуя той же логике, Дарвин считал, что естественный отбор слепо скорректировал структуры живых организмов. Например, крылья птиц, которые помогают им летать, являются «ложной целью». Это означает мнимую цель, а не реальную! Глаз — это иллюзорная цель, потому что не существует избранного агента, который хотел бы, чтобы глаз видел или чтобы крыло взмахивало. Скорее всего, все это произошло благодаря скоплению слепых совпадений!<br>

    Это шутка о слепом естественном отборе, придуманная Дарвином, которая – помимо ее абсурдности для каждого здравомыслящего человека – заключается в том, что научные открытия оказались невозможными при наличии непреодолимой сложности во всех деталях живых организмов и их взаимоотношений. То есть структуры и органы живых организмов настолько сложны и интегрированы, что могут существовать только при одновременном наличии своих частей. В противном случае он не выполнит свою работу. Поэтому они вообще не поддаются идее постепенного формирования, даже на уровне самой маленькой живой единицы.<br><br>

    В свое время Дарвин видел клетку под микроскопом только в виде простого мазка!<br><br>

    Естественный отбор, как его изображал Дарвин, тоже миф.<br><br>

    На основе этих суеверий, не имеющих под собой ни разума, ни чувств, ни опыта, Дарвин выдвинул самую нелепую и глупую идею в истории. В том, что все, что мы видим в этом творении мудрости и мастерства, произошло случайно, без намерения и не требует знаний или мудрости!<br><br>

    Увидев несостоятельность этой теории, вы должны поверить, что Вселенная не может быть результатом совпадения, а также поверить, что «Бог должен быть».<br><br>
    <a target="_blank" href="https://www.youtube.com/watch?v=x0jw56ylJOE&list=PL56IcDjrf3YJr__TEOJ2UOv3jCzht1_yc&index=24">Подробнее о (мифе эволюции) [видео - русские субтитры].</a><br>
    <a target="_blank" href="https://www.youtube.com/playlist?list=PL56IcDjrf3YJr__TEOJ2UOv3jCzht1_yc">Ещё [плейлист] (начните с первого клипа серии или с клипа №24 и до конца).</a>
</div>

<div class="part">
    <h1>Третий абзац: выбор правильной религии</h1>
    Согласимся, что любая религия, придуманная человеком, недействительна, потому что религия должна исходить от Творца, а правильная религия не должна содержать никаких противоречий и ошибок. Сейчас у нас есть три монотеистические религии: иудаизм, христианство и ислам.<br><br>

    🔷 Первое: иудаизм<br>
    Чтобы стать евреем, вы должны быть из еврейской семьи, потому что, согласно иудаизму, эти семьи являются избранным Богом народом, и, конечно, эта религия ложна, потому что несправедливо, если вы хотите поклоняться своему Создателю, а тогда вы не можете этого сделать. даже заслуживаешь мучений, потому что ты не из еврейской семьи.<br><br>

    🔷 Второе: христианство<br>
    <ul>
        <li>В христианстве вы должны верить, что у Бога есть три бога: Отец, Сын и Святой Дух. Эту идею создали какие-то жрецы, но как может быть три бога? Если Отец, Сын и Святой Дух — боги, то они все могут управлять вселенной, но Сын — это человек, а человек не может контролировать вселенную.</li><br>
        <li>В христианстве Библия — это Евангелие, а Евангелие было искажено «людьми». Я хочу, чтобы вы прочитали о «версиях» Евангелия и о противоречиях этих версий друг другу, хотя еврейский текст Евангелия один и тот же. Например, возраст прихода к власти Давида, это 1, 30 или 40 лет (хотя еврейский текст один и тот же, Евангелия в этом ответе различаются)</li><br>
        <li>Если отец хочет, чтобы кто-то умер в 4 года, а сын хочет, чтобы этот человек умер в 5 лет, когда этот человек умрет? Если вы скажете, что он умрет в 4 года, то сын не будет Богом, а если вы скажете, что он умрет в 5 лет, то отец не будет Богом, потому что Бог может управлять вселенной.</li><br>
        <li>В христианстве существует принижение Бога.Например, в Библии есть история о том, что Бог боролся с Иаковом, и Давид чуть не убил его. Но мы согласились, что Бог должен быть совершенным, поскольку именно Бог создал всю вселенную, так как же Давид мог быть сильнее его?</li><br><br>
    
        <li>Пятая причина:</li><br>
        <ul>
            <li>В христианстве Бог послал Сына на распятие, чтобы искупить грех Адама, но кто совершил грех, Сын или Адам? В чем грех сына, если грех совершил Адам</li><br>?
            <li>В христианстве Сын сошел на распятие, чтобы искупить грехи людей после него, но те, кто умер до Сына, умерли за грех! Но в чем вина того, кто умер раньше сына, чтобы умереть за грех? Почему Сын не сошел раньше этого, чтобы искупить грехи большего числа людей?</li><br>
            <li>Где в Библии Сын сказал: «Я есть Бог»? Где он сказал поклоняться мне? Где он сказал: «Я — воплощенный Бог»? Где он говорил о грехе? Где он сказал: «Я Сын Божий»? Где он сказал: «Я Бог Слово»? А где он сказал: «Я Бог, второе лицо?»</li>
        </ul>
    </ul>

    <br>

    <a target="_blank" href="https://www.youtube.com/watch?v=M71t_GmkJ1g">Подробнее о (Христианстве) [видео - русские субтитры].</a><br>
    <a target="_blank" href="https://www.youtube.com/watch?v=7iFCMs8jE8k">Подробнее о (Троице) [видео - русские субтитры].</a><br>

    <br><br>

    Теперь у нас есть последняя религия – ислам. Но прежде чем продолжить, не верьте словам священников, СМИ и фильмам об Исламе. Их миссия - исказить образ Ислама. Не верьте им и ищите истину сами, а давайте пойдём. (Он следует)
</div>

<div class="part">
    <h1>Четвертый абзац: Действительно ли вы знаете ислам?</h1>
    Ислам призывает к поклонению Единому Богу, у которого нет сотоварища, у которого нет бога, и призывает верить в Посланника Бога и Его Пророка Мухаммада – да благословит его Господь и дарует ему мир –.<br>
    Для принятия Ислама читают две Шахады:<br>
    Я свидетельствую, что нет бога, кроме Аллаха, и свидетельствую, что Мухаммад — Его слуга и Посланник<br><br>

    <a target="_blank" href="https://www.islam-guide.com/ch3-8.htm">Подробнее о Посланнике - да благословит его Бог и дарует ему мир - [Статья]</a> <br>
    <a target="_blank" href="https://www.youtube.com/watch?v=_JbKdKS9Yyg">Подробнее о Посланнике - да благословит его Бог и дарует ему мир - [Клип]</a><br <br>

    Ислам – это религия, соответствующая природе, поскольку она призывает поклоняться единому Богу – Аллаху.<br><br>

    Бог - Создатель всего. Он - Создатель вселенной. У Него нет партнера или подобного Ему. Бог совершенен и не имеет каких-либо недостатков или изъянов. Вы должны поклоняться Ему одному.<br><br>

    Давайте узнаем о столпах ислама, которые делают вас мусульманином:<br>
    1. Два сертификата<br>
    2. Пять молитв<br>
    3. Выдача (выплата) закята<br>
    4. Пост в Рамадан<br>
    5. Хадж<br><br>

    Рамадан — месяц хиджры, в котором необходимо перестать есть и пить от рассвета до заката, так как есть ночь, называемая Лейлат аль-Кадр. Кто добьется ее, для того это лучше тысячи месяцев.<br>

    <h3>Акида (вера/убеждение мусульманина)</h3>
    Мусульманин верит, что Бог — владелец и создатель небес и земли и владелец всего, Господь посланников, и Он — тот, кто послал посланников от первого нашего господина Адама, первого человечества. последнему из пророков и посланников, нашему господину Мухаммаду - да благословит его Бог и дарует ему мир - поклоняться единому Богу и прославлять (великолепно) Бога, что на небесах и что на ней.Земля.<br <br>

    Если люди не поклоняются Богу, это не изменит истины, которая заключается в том, что Бог является их создателем и что именно Он ведет их к прямому пути и правильному пути (ислам).<br><br>



    <h3>Шариат (исламские законы)</h3>
    Шариат - это законы Бога, такие как молитва, пост, благотворительность, хорошие манеры, ношение хиджаба и построение хороших отношений с людьми.Ислам - это образ жизни и содержит законы, которые улучшают человека и общество и приближают их к Богу. .<br><br>

    Вы должны следовать Божьим установлениям и избегать запретных вещей, и если вы думаете, что это не свобода, например, если ваш сын пойдет на рынок и захочет съесть все сладости на рынке, вы ему помешаете, не так ли? Вы хотите, чтобы он лишился свободы, или вы знаете, что, если он это сделает, он причинит себе вред?<br><br>

    Бог создал вселенную, зная, что нам вредит, и Бог создал мир как место скорби и усталости, а не как место награды, а местом награды является загробная жизнь (после смерти).<br><br>

    <h3>Молитва</h3>
    Время молитвы в каждой стране меняется из-за сезонных изменений, это больше связано со временем суток. Например: Фаджр-молитва перед восходом солнца, примерно во время рассвета. Не разрешается молиться на восходе солнца, затем в полдень, затем днем, затем на закате и вечером. Если меняется время восхода и захода солнца, меняется и время молитвы.<br><br>

    <h3>Священный Коран</h3>
    Коран - слово Бога. Коран был ниспослан на арабском языке в арабской стране, когда арабы были более красноречивыми, бросая вызов всем арабам в своем красноречии и красоте своих слов, и до сих пор нет ничего подобного ему. . (Сура является частью Корана).<br><br>

    <a target="_blank" href="https://www.youtube.com/watch?v=TGuZMLhyRXg">Еще (Есть ли кто-нибудь, кто написал что-то вроде Корана?!) [клип на английском языке]</a <br>< бр>

    Коран не искажен, и вы можете проверить это, выполнив поиск самого старого Корана, поскольку между ним и самым последним Кораном нет никакой разницы (кроме рукописного текста), а вашу уверенность увеличивает... .Коран - это аудиокнига до того, как он стал письменной книгой, и есть то, что называется разрешением на чтение Священного Корана, которое представляет собой связную цепочку того, что Он освоил, читая Коран Пророку Мухаммеду - да благословит его Бог и дарует ему мир -.<br><br>

    Коран может быть переведен на любой другой язык мира, чтобы люди могли понять то, что они читают, но Бог ниспослал откровение на арабском языке, поэтому арабский язык можно считать единственным языком «откровения». Другие языки — это всего лишь перевод Корана. 80% мусульман не арабы, но они все еще могут читать и понимать Коран, а также ежедневно читать Коран в молитве. Однако, если вы хотите получить полный опыт, вам придется выучить арабский язык, поскольку большинство исламских источников написаны на арабском языке.<br><br>

    <a target="_blank" href="https://www.youtube.com/watch?v=mJyNYxPEiMw">Изучите Коран (отрывок с дорожной картой на английском языке)</a><br>
    <a target="_blank" href="https://arabic101.org/wp-content/uploads/woocommerce_uploads/2023/03/quran-quest_2.pdf">Изучите Коран (дорожная карта в формате PDF)</a><br >

    <h3>Закят</h3>
    В Исламе вообще нет налогов, взимаемых правительством. Никаких налогов быть не должно, потому что это неисламская концепция. Если немусульманин желает жить под властью исламского правительства, он или она платит джизью, налог, взимаемый с немусульман, чтобы обеспечить им безопасность и защищенность, а также доступ к тем же услугам и привилегиям, которыми пользуются мусульмане. Что касается мусульманина, то он выполняет одну из обязанностей ислама, называемую закятом. Мусульмане обязаны ежегодно выплачивать бедным 2,5% своего богатства, при этом джизья намного меньше закята. Это делает общество лучше и компенсирует недостаток ресурсов и привилегий между бедными и богатыми, одновременно поддерживая друг друга. Мусульманину не разрешено брать закят с других мусульман, если он в этом не нуждается. Поэтому в истории были времена, когда исламским правителям не было бедняков, которых можно было бы кормить, и население жаловалось на то, кто раздает милостыню.<br>
</div>
